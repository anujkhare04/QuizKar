...
const quizchose = ({ setQuizData }) => {
  ...
  return (
    <div className="bg-gradient-to-r from-orange-200 via-purple-500 to-pink-500 min-h-screen  ">


      <div className="min-h-screen">
        <h1 className="text-4xl shadow-md font-normal f2 py-10 text-black text-center">
        Take the Quiz
      </h1>
      ...
      <form onSubmit={handleSubmit(onsubmit)}>
        ...
        <div className="w-full max-w-md mx-auto px-6">
          <h1 className="f3 mt-10 text-xl">Select Types of Test</h1>

          <select
            {...register("type", { required: true })}
            className="w-full rounded mt-6 h-10 p-2 text-black shadow-sm focus:outline-none"
            name="type"
          >
          ...
          <div className="flex justify-center mt-10 mb-20">
            <button
              className="f2 px-10 py-3 mb-10 bg-orange-100 rounded-sm active:scale-95 shadow-sm hover:bg-orange-200 transition-colors"
            >
              Submit
            </button>
          </div>
